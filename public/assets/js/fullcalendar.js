...
function AgendaView(element, calendar, viewName) {
  ...
  var allRowsTimestamp = calendar.options.allRowsTimestamp;
  var hasAxisRange = calendar.options.hasAxisRange;
  var axisRangeSeparator = calendar.options.axisRangeSeparator;
