...
$(function () {
  ...
  */
  ...
  tour.addStep({
    ...
    placement: "right",
    title: "Vamos!",
    content: "Presiones siguiente para conocer las funciones que le permitirán administrar sus secretarias, de lo contrario puede terminar el tour.",
    //next: 0,
    //prev: 0,
    animation: true,
    container: "body",
...
*/
  ...
  tour.addStep({
    ...
    content: "Escriba el RUT de la persona para ligarla a sus servicios.",
    //next: 0,
    //prev: 0,
    animation: true,
    container: "body",
